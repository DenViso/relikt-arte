...
class CorsSettings(BaseSettings):
    origins: str = Field(
        ...
        default="https://localhost:3000,http://localhost:5173,https://relikt-arte.vercel.app,https://relikt.vercel.app,https://relikt.netlify.app,https://relikt-arte.vercel.app/"
    )
